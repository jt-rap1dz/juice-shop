...
import { PrinsipComponent } from './prinsip.component'
import { MatCardModule } from '@angular/material/card'
import { NO_ERRORS_SCHEMA } from '@angular/core'
import { of } from 'rxjs'
import { ConfigurationService } from '../Services/configuration.service'

describe('PrinsipComponent', () => {
  let component: PrinsipComponent
  let fixture: ComponentFixture<PrinsipComponent>
  let slideshowModule
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(PrinsipComponent)
